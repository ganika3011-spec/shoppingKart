...
def payments(request):
   ...
   # payment=Payments(user=request.user,payment_id= body["transID"],payment_method=body["payment_method"],amount_paid=order.order_total,status=body["status"])
   # payment.save()
   ...
   #move the cart items to order product table
    ...
    #for item in cart_items:
     #   orderproduct=Orderrderproduct()
        #orderpproduct.order_id=order.id
   ...
   #areduce the quantity of sold products
   ...
   #mail_subject = 'Thankyou for ordering'
...
def order_complete(request):
    ...
    #context={ 'order':order,'order_products':order_products,"order_number":order.order_number}
